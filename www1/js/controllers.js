...
.controller('PromocionesCtrl', ['$scope', '$location','$state','$filter','$state','$ionicLoading', '$http','$ionicPopup','$ionicHistory', 'JsonSvc',
            function($scope, $location,$state,$filter,$state,$ionicLoading, $http,$ionicPopup,$ionicHistory, JsonSvc) {
    ...
    $scope.promociongolmap = [];
     ...
     JsonSvc.read('http://golmap.com/temporal/getPromociones',$scope)
      .then(function () {
        ...
        else
        {
          ...
          //$location.path("/Buscar")
             ...
             // http://golmap.com/temporal/getPromociones
    
    
    
     $scope.promogolmap = function() { 
	          JsonSvc.read('http://golmap.com/temporal/getPromociones',$scope)
      .then(function () {
